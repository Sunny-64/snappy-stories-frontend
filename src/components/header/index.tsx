                ...
                <div className="flex gap-6 lg:gap-8">
                    <div className="hidden sm:flex items-center font-medium text-md gap-8 lg:gap-5">
                        <p>
                          ...
                          <span className="md:hidden text-lg"><FaMagnifyingGlass /></span>
                        </p>
                        <p>
                          <span className="sm:hidden md:block">Post</span>
                          <span className="md:hidden text-lg"><FaStore /></span>
                        </p>
                        <p>
                          <span className="sm:hidden md:block">Write</span>
                          <span className="md:hidden text-lg"><FaPenNib /></span>
                        </p>
                        <p>
                          <span className="sm:hidden md:block">Chats</span>
                          <span className="md:hidden text-lg"><FaMessage /></span>
                        </p>
                    </div>
                    ...
                    <p className="flex items-center gap-2">
                        <Image
                            ...
                            height="40"
                        />
                        <span className="hidden md:block font-medium text-md sm:hidden">@username</span>
